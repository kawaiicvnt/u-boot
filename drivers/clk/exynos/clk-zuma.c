...
static const unsigned long cmu_top_clk_regs[]  = {
...
static const struct samsung_pll_clock cmu_top_pll_clks[]  = {
	/* CMU_TOP_PURECLKCOMP */
	PLL_FULL(pll_0517x, CLK_FOUT_SHARED0_PLL, "fout_shared0_pll", "oscclk", PLL_LOCKTIME_PLL_SHARED0, PLL_CON3_PLL_SHARED0, NULL),
	PLL_FULL(pll_0517x, CLK_FOUT_SHARED1_PLL, "fout_shared1_pll", "oscclk", PLL_LOCKTIME_PLL_SHARED1, PLL_CON3_PLL_SHARED1, NULL),
	PLL_FULL(pll_0518x, CLK_FOUT_SHARED2_PLL, "fout_shared2_pll", "oscclk", PLL_LOCKTIME_PLL_SHARED2, PLL_CON3_PLL_SHARED2, NULL),
	PLL_FULL(pll_0518x, CLK_FOUT_SHARED3_PLL, "fout_shared3_pll", "oscclk", PLL_LOCKTIME_PLL_SHARED3, PLL_CON3_PLL_SHARED3, NULL),
	PLL_FULL(pll_0518x, CLK_FOUT_SPARE_PLL, "fout_spare_pll", "oscclk", PLL_LOCKTIME_PLL_SPARE, PLL_CON3_PLL_SPARE, NULL),
};
...
static const struct samsung_mux_clock cmu_top_mux_clks[]  = {
...
static const struct samsung_div_clock cmu_top_div_clks[]  = {
...
static const struct samsung_fixed_factor_clock cmu_top_ffactor[]  = {
...
static const struct samsung_gate_clock cmu_top_gate_clks[]  = {
...
static const struct samsung_fixed_rate_clock apm_fixed_clks[]  = {
	FRATE(CLK_APM_PLL_DIV2_APM, "pll_alv_div2_apm", 400000000),
	FRATE(CLK_APM_PLL_DIV4_APM, "pll_alv_div4_apm", 200000000),
	FRATE(CLK_APM_PLL_DIV16_APM, "pll_alv_div16_apm", 50000000),
};
...
static const struct samsung_pll_rate_table cmu_hsi0_usb_pll_rates[]  = {
	/*
...
static const struct samsung_pll_clock cmu_hsi0_pll_clks[]  = {
	PLL_FULL(pll_0518x, CLK_FOUT_USB_PLL, "fout_usb_pll", "oscclk", PLL_LOCKTIME_PLL_USB, PLL_CON3_PLL_USB, cmu_hsi0_usb_pll_rates),
};
...
static const struct samsung_fixed_rate_clock hsi0_fixed_clks[]  = {
	FRATE(0, "tcxo_hsi1_hsi0", 26000000),
	FRATE(0, "usb20phy_phy_clock", 120000000),
	/* until we implement APMGSA */
	FRATE(0, "ioclk_clk_hsi0_alt", 213000000),
};
...
static const unsigned long cmu_hsi2_clk_regs[]  = {
...
struct zuma_cmu_match_data {
	enum exynos850_cmu_id cmu_id;
	const struct samsung_cmu_info *info;
};

struct zuma_cmu_priv {
	enum exynos850_cmu_id cmu_id;
};

static int zuma_cmu_of_xlate(struct clk *clk, struct ofnode_phandle_args *args)
{
	struct zuma_cmu_priv *priv = dev_get_priv(clk->dev);

	if (args->args_count > 1)
		return -EINVAL;

	clk->id = SAMSUNG_TO_CLK_ID(priv->cmu_id, args->args_count ? args->args[0] : 0);

	return 0;
}

static const struct clk_ops zuma_cmu_ops = {
	.set_rate = ccf_clk_set_rate,
	.get_rate = ccf_clk_get_rate,
	.set_parent = ccf_clk_set_parent,
	.enable = ccf_clk_enable,
	.disable = ccf_clk_disable,
	.of_xlate = zuma_cmu_of_xlate,
	.request = samsung_clk_request,
};

static int zuma_cmu_probe(struct udevice *dev)
{
...
static const struct zuma_cmu_match_data zuma_cmu_top_match = {
	.cmu_id = CMU_TOP,
	.info = &top_cmu_info,
};

static const struct zuma_cmu_match_data zuma_cmu_apm_match = {
	.cmu_id = CMU_APM,
	.info = &apm_cmu_info,
};

static const struct zuma_cmu_match_data zuma_cmu_dpu_match = {
	.cmu_id = CMU_DPU,
	.info = &dpu_cmu_info,
};

static const struct zuma_cmu_match_data zuma_cmu_hsi0_match = {
	.cmu_id = CMU_HSI0,
	.info = &hsi0_cmu_info,
};

static const struct zuma_cmu_match_data zuma_cmu_hsi2_match = {
	.cmu_id = CMU_HSI2,
	.info = &hsi2_cmu_info,
};

static const struct zuma_cmu_match_data zuma_cmu_misc_match = {
	.cmu_id = CMU_MISC,
	.info = &misc_cmu_info,
};

static const struct zuma_cmu_match_data zuma_cmu_peric0_match = {
	.cmu_id = CMU_PERIC0,
	.info = &peric0_cmu_info,
};

static const struct zuma_cmu_match_data zuma_cmu_peric1_match = {
	.cmu_id = CMU_PERIC1,
	.info = &peric1_cmu_info,
};

static const struct udevice_id zuma_cmu_of_match[] = {
	{ .compatible = "google,zuma-cmu-top", .data = (ulong)&zuma_cmu_top_match },
	{ .compatible = "google,zumapro-cmu-top", .data = (ulong)&zuma_cmu_top_match },
	{ .compatible = "google,zuma-cmu-apm", .data = (ulong)&zuma_cmu_apm_match },
	{ .compatible = "google,zuma-cmu-dpu", .data = (ulong)&zuma_cmu_dpu_match },
	{ .compatible = "google,zuma-cmu-hsi0", .data = (ulong)&zuma_cmu_hsi0_match },
	{ .compatible = "google,zumapro-cmu-hsi0", .data = (ulong)&zuma_cmu_hsi0_match },
	{ .compatible = "google,zuma-cmu-hsi2", .data = (ulong)&zuma_cmu_hsi2_match },
	{ .compatible = "google,zumapro-cmu-hsi2", .data = (ulong)&zuma_cmu_hsi2_match },
	{ .compatible = "google,zuma-cmu-misc", .data = (ulong)&zuma_cmu_misc_match },
	{ .compatible = "google,zumapro-cmu-misc", .data = (ulong)&zuma_cmu_misc_match },
	{ .compatible = "google,zuma-cmu-peric0", .data = (ulong)&zuma_cmu_peric0_match },
	{ .compatible = "google,zumapro-cmu-peric0", .data = (ulong)&zuma_cmu_peric0_match },
	{ .compatible = "google,zuma-cmu-peric1", .data = (ulong)&zuma_cmu_peric1_match },
	{ .compatible = "google,zumapro-cmu-peric1", .data = (ulong)&zuma_cmu_peric1_match },
	{ }
};

U_BOOT_DRIVER(zuma_cmu) = {
	.name		= "zuma_cmu",
	.id		= UCLASS_CLK,
	.of_match	= zuma_cmu_of_match,
	.probe		= zuma_cmu_probe,
	.priv_auto	= sizeof(struct zuma_cmu_priv),
	.ops		= &zuma_cmu_ops,
};
